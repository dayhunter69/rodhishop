...
const Canceled = () => {
  return (
    <>
      <div className="w-[369px] h-[420px] flex items-center justify-center bg-white mt-[15px] shadow-custom1">
        <div className="w-[320px]">
          ...
          <div className="mt-[13px]">
            <p className="font-Arial not-italic font-normal text-Paragraph0 capitalize text-secondary-darkOpacity text-center">
              Canceled reason: Delivery time delay
            </p>
            ...
            <div className="mt-[15px]">
              <p className="font-Arial not-italic font-normal text-Paragraph0 capitalize text-secondary-darkOpacity text-center">
                your feedback on our cancellation process is important to us.
                pleas share your experience so we can improve.
              </p>
            </div>
            <div className="mt-[15px]">
