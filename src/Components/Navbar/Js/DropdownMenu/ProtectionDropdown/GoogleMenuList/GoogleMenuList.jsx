...
import { options } from "../GoogleMenuList/setup";
import PhoneCaseSideNav from "../PhoneCase/PhoneCaseSideNav";

const GoogleMenuList = ({
  phonecaseType,
  handleShowClick,
  handleClick,
  handleClose,
  ...
  const handleClickEnter = () => {
    query.set("googleModal", earphoneType.googleModal);
    query.set("googleColor", earphoneType.googleColor);
    query.set("googlePrice", earphoneType.googlePrice);

    handleClose();
    navigate(`/google?${query.toString()}`, { replace: true });
  };

  const isItemSelected = () => {
    return (
      earphoneType.googleColor ||
      earphoneType.googleModal ||
      earphoneType.googlePrice
    );
  };
