...
import img1 from '../../../../StudioBoxImage/Backdrop/img1.jpg';
  ...
  return (
    <>
      <div className="w-[93%] mx-auto my-0">
        <Slider {...settings}>
          {BackdropProducts.map((data, index) => {
            return (
              <div key={data.id}>
                  ...
                  <div className="max-w-[320px] max-h-[125px] mt-[15px] mobile:mt-[5px] mobile:w-[146px]">
                    <p
                      className="font-Arial not-italic font-normal text-Paragraph2 text-center
                       text-red-500 pt-[8px] mobile:text-Paragraph0 mobile:pt-[2px]"
                    >
                      {data.price}
                    </p>
                    <p
