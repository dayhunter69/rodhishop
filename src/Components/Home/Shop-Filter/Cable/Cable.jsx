...
import NextArrow from "./Carousel/NextArrow/NextArrow";
import PreviousArrow from "./Carousel/PreviousArrow/PreviousArrow";
...
const Cable = () => {
  ...
  return (
    <>
      <div className="w-[93%] mt-[12px] mx-auto mb-0">
        <Slider {...settings}>
