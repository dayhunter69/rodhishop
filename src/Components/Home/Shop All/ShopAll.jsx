...
const ShopAll = () => {
  ...
  return (
    <>
      <div className="w-[93%] mt-[45px] mb-[70px] mx-auto mobile:mb-[45px]">
        <div className="mobile:max-w-[322px] mobile:my-0 mobile:mx-auto mb-[50px]">
          <p
            className="font-Arial not-italic font-bold text-Heading text-center 
            uppercase text-primary mobile:text-Paragraph2"
          >
            shop ALL
          </p>
        </div>
        <div className="mobile:mt-[22px]">
          <Slider {...settings}>
            {shopAllData.map((data, index) => {
              return (
                <div
                  key={index}
                  className="max-w-[320px] h-[460px] flex flex-col items-center justify-between mx-auto my-0 mobile:w-[150px] mobile:h-auto"
                >
                  <div
