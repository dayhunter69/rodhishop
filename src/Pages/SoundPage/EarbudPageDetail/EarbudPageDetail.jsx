...
import imgA from "../../../Components/images/earbud.png";
import imgB from "../../../Components/images/earbud2.png";
...
const EarbudPageDetail = ({ tabactive, handleBackClick, show }) => {
  const [select, setSelect] = useState("");
  const [clicked, setClicked] = useState(false);
  const [active, setActive] = useState();
  const [hie, setHie] = useState(true);
  const [leae, setLeae] = useState(true);
...
export default EarbudPageDetail;
