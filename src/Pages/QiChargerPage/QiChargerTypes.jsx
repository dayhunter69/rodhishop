...
import img1 from "../../Components/images/wireless-charging-A.jpg";
import img2 from "../../Components/images/wireless-charging-station-packaging.jpg";
import img3 from "../../Components/images/wireless-charging-station-light.jpg";
...
const QiChargerTypes = () => {
  ...
  const handleLoadMore = () => {
    if (QiChargerData.length === imageLength) return;
    setImageLength((prev) => prev + 4);
  };
  return (
    <>
      <div className="w-[1349px] flex flex-wrap gap-[22px] mt-[10px] mobile:w-[333px] mobile:mx-auto justify-center">
