...
import img2 from "../../Components/images/headset-package.jpg";
...
import img6 from "../../Components/images/headset-ergonomic.jpg";
import img7 from "../../Components/images/tws-headset-package.jpg";
import img8 from "../../Components/images/crystal-color-tws-earbuds.jpg";
import img9 from "../../Components/images/crystal-color-tws-earbuds-packaging.jpg";
import img10 from "../../Components/images/crystal-color-tws-earbuds-case.jpg";

export const soundtypeData = [
  {
    id: 1,
    Img: img1,
    hoverImg: img2,
...
const SoundAllType = () => {
  ...
  const handleLoadMore = () => {
    if (soundtypeData.length === imageLength) return;
