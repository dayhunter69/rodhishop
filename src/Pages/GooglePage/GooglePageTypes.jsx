...
import img1 from "../../Components/images/pixel 4xl zero slim clear.png";
import img2 from "../../Components/images/pixel 4a air armor case.png";
import img3 from "../../Components/images/pixel 4a meta kickstand fp.png";
import img4 from "../../Components/images/Pixel 4a Air Armor 360-Degree Protection Bundle.png";
import img5 from "../../Components/images/Pixel 4a Metal Kickstand Full-Protection Bundle.png";
...
const GooglePageTypes = () => {
  ...
  const handleLoadMore = () => {
    if (googlepageData.length === imageLength) return;
...
export default GooglePageTypes;
