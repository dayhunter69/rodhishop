...
import img1 from "../../Components/images/huawei p30 pro.png";
import img2 from "../../Components/images/Huawei P30 Pro Tempered Glass.png";
...
const HuaweiPageTypes = () => {
  ...
  const handleLoadMore = () => {
    if (huaweipageData.length === imageLength) return;
...
export default HuaweiPageTypes;
